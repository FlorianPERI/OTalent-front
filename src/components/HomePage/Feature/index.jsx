...
import Fast from '/src/assets/Fast loading-bro';
import LearningBro from '/src/assets/Learning-bro';
import GroupChat from '/src/assets/Group Chat-bro';
/**
 * Feature component
...
export default function Feature() {
  const data = [
    ...
    {
      title: 'Actif',
      description: 'Une communauté active \n Banque mise à jour régulièrement',
      image: <GroupChat />,
    },
  ];
