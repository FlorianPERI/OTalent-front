...
import WhitePath from '/src/assets/WhitePath';
import React from 'react';
import Treasure from '/src/assets/Treasure-bro';
import Account from '/src/assets/Account-bro';
import Typing from '/src/assets/Typing-bro';
import ColoredPath from '/src/assets/ColoredPath';
      ...
      <div className="flex flex-col xl:flex-row h-full w-full items-start justify-center gap-2">
        <div className="flex flex-col h-full justify-center items-center w-full">
          <div className="relative flex flex-col p-5 gap-2 w-1/2 bg-white rounded-2xl shadow-xl shadow-black min-w-72">
            <div className="absolute hidden xl:block w-48 -left-32 -top-40">
              <Treasure />
            </div>
            <h4>Découvrez nos formations</h4>
            <p>
              Parcourez la liste de nos formations pour trouver celle qui vous
              convient et ajoutez-les à vos favoris
            </p>
          </div>
        </div>
        <div
          ...
          ref={svgContainerRef}
        >
          <div id="svg-black" className=" text-primary-color absolute">
            <ColoredPath />
          </div>
          <div
            id="svg-white"
        ...
        <div className="flex flex-col h-full gap-2 justify-around xl:justify-between items-center w-full">
          <div className="relative flex flex-col p-5 gap-2 w-1/2 bg-white rounded-2xl shadow-xl shadow-black min-w-72">
            <div className="absolute hidden xl:block w-48 -right-32 -top-32">
              <Account />
            </div>
            <h4>Inscrivez-vous</h4>
            <p>
              Renseignez vos informations et choisissez vos catégories préférées
              afin que l’on puisse mieux vous connaître
            </p>
          </div>
          <div className="relative flex flex-col p-5 gap-2 w-1/2 bg-white rounded-2xl shadow-xl shadow-black min-w-72">
            <div className="absolute hidden xl:block w-48 -right-32 -top-32">
            ...
            <p>
              Prenez contact avec les organismes de formation qui vous
              intéressent et commencez votre formation
            </p>
          </div>
        </div>
      </div>
