...
import Security from '/src/assets/Security On-bro';
    ...
    return (
      <div className="flex justify-center">
        <div className="modal-box">
          <h4>
            Il semblerait que vous essayez d'accéder à un endroit secret...
          </h4>
          <div>
            <Security />
          </div>
    ...
    <div className="flex justify-center w-full">
      <div className="flex flex-col items-center w-full">
          ...
          <form className="modal-box">
            ...
            <div className="flex justify-center mb-5">
              <input
                ...
                onFocus={e => (e.target.placeholder = '')}
                onBlur={e =>
                  (e.target.placeholder = 'Confirmez le nouveau mot de passe')
                }
                onChange={e => {
        ...
        {buttonToAccesFormConnection && (
          <div className="modal-box">
            <p>
              Votre mot de passe a bien été modifié, vous pouvez désormais vous
        ...
        {isLoading && (
          <>
            <h4 className="text-xl md:text-3xl mb-5  text-center">
              Pour éviter que cela recommence, O'Talent vous recommande...
            </h4>
